            ...
            modelBuilder.Entity("GLAA.Domain.Models.PrincipalAuthority", b =>
                {
                    ...
                    b.Property<int?>("DirectoryOrPartnerId");
                    ...
                    b.Property<bool?>("HasPreviousTradingNames");
                    ...
                    b.HasIndex("DirectoryOrPartnerId");
            ...
            modelBuilder.Entity("GLAA.Domain.Models.Licence", b =>
                {
                    ...
                    b.HasOne("GLAA.Domain.Models.Multiple")
                        .WithMany("Licences")
                        .HasForeignKey("MultipleId");
            ...
            modelBuilder.Entity("GLAA.Domain.Models.PrincipalAuthority", b =>
                {
                    ...
                    b.HasOne("GLAA.Domain.Models.DirectorOrPartner", "DirectorOrPartner")
                        .WithMany()
                        .HasForeignKey("DirectoryOrPartnerId");
