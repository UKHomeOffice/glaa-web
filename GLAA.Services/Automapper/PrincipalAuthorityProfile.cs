    ...
    public class PrincipalAuthorityProfile : Profile
    {
        ...
        public PrincipalAuthorityProfile()
        {
            CreateMap<PrincipalAuthority, PrincipalAuthorityViewModel>()
                ...
                .ForMember(x => x.BirthDetails, opt => opt.ResolveUsing(ProfileHelpers.BirthDetailsResolver<PrincipalAuthorityViewModel>))
                ...
                .ForMember(x => x.Passport, opt => opt.ResolveUsing(ProfileHelpers.PassportViewModel))
                .ForMember(x => x.PrincipalAuthorityRightToWork, opt => opt.ResolveUsing(PrincipalAuthorityRightToWorkResolver))
                .ForMember(x => x.UndischargedBankrupt, opt => opt.ResolveUsing(ProfileHelpers.UndischargedBankruptResolver))
                .ForMember(x => x.DisqualifiedDirector, opt => opt.ResolveUsing(ProfileHelpers.DisqualifiedDirectorResolver))
                .ForMember(x => x.RestraintOrders, opt => opt.MapFrom(y => y))
                .ForMember(x => x.UnspentConvictions, opt => opt.MapFrom(y => y))
                .ForMember(x => x.OffencesAwaitingTrial, opt => opt.MapFrom(y => y))
                .ForMember(x => x.PreviousLicence, opt => opt.ResolveUsing(ProfileHelpers.PreviousLicenceResolver))
            ...
            CreateMap<PrincipalAuthorityViewModel, PrincipalAuthority>()
                ...
                .ForMember(x => x.TownOfBirth, opt => opt.MapFrom(y => y.BirthDetails.TownOfBirthViewModel.TownOfBirth))
                .ForMember(x => x.CountryOfBirthId, opt => opt.MapFrom(y => y.BirthDetails.CountryOfBirthViewModel.CountryOfBirthId))
                ...
                .ForMember(x => x.NationalInsuranceNumber, opt => opt.MapFrom(y => y.BirthDetails.NationalInsuranceNumberViewModel.NationalInsuranceNumber))
                .ForMember(x => x.SocialSecurityNumber, opt => opt.MapFrom(y => y.BirthDetails.SocialSecurityNumberViewModel.SocialSecurityNumber))
                ...
                .ForMember(x => x.HasPassport, opt => opt.MapFrom(y => y.Passport.HasPassport))
                .ForMember(x => x.PermissionToWorkStatus, opt => opt.MapFrom(y => y.PrincipalAuthorityRightToWork.RightToWorkInUk))
                .ForMember(x => x.VisaNumber, opt => opt.MapFrom(y => y.PrincipalAuthorityRightToWork.VisaNumber))
                .ForMember(x => x.LengthOfUKWorkYears, opt => opt.MapFrom(y => y.PrincipalAuthorityRightToWork.LengthOfUKWork.Years))
                .ForMember(x => x.LengthOfUKWorkMonths, opt => opt.MapFrom(y => y.PrincipalAuthorityRightToWork.LengthOfUKWork.Months))
                .ForMember(x => x.ImmigrationStatus, opt => opt.MapFrom(y => y.PrincipalAuthorityRightToWork.ImmigrationStatus))
                .ForMember(x => x.LeaveToRemainTo, opt => opt.MapFrom(y => y.PrincipalAuthorityRightToWork.LeaveToRemainTo.Date))
                .ForMember(x => x.IsUndischargedBankrupt, opt => opt.MapFrom(y => y.UndischargedBankrupt.IsUndischargedBankrupt))
                .ForMember(x => x.BankruptcyDate, opt => opt.MapFrom(y => y.UndischargedBankrupt.BankruptcyDate.Date))
                .ForMember(x => x.BankruptcyNumber, opt => opt.MapFrom(y => y.UndischargedBankrupt.BankruptcyNumber))
                .ForMember(x => x.IsDisqualifiedDirector, opt => opt.MapFrom(y => y.DisqualifiedDirector.IsDisqualifiedDirector))
                .ForMember(x => x.DisqualificationDetails, opt => opt.MapFrom(y => y.DisqualifiedDirector.DisqualificationDetails))
                .ForMember(x => x.HasRestraintOrders, opt => opt.MapFrom(y => y.RestraintOrders.HasRestraintOrders))
                .ForMember(x => x.RestraintOrders, opt => opt.Ignore())
                .ForMember(x => x.HasUnspentConvictions, opt => opt.MapFrom(y => y.UnspentConvictions.HasUnspentConvictions))
                .ForMember(x => x.UnspentConvictions, opt => opt.Ignore())
                .ForMember(x => x.HasOffencesAwaitingTrial, opt => opt.MapFrom(y => y.OffencesAwaitingTrial.HasOffencesAwaitingTrial))
                .ForMember(x => x.OffencesAwaitingTrial, opt => opt.Ignore())
                .ForMember(x => x.HasPreviouslyHeldLicence, opt => opt.MapFrom(y => y.PreviousLicence.HasPreviouslyHeldLicence))
                .ForMember(x => x.PreviousLicenceDescription, opt => opt.MapFrom(y => y.PreviousLicence.PreviousLicenceDescription))
