    ...
    public class AlternativeBusinessRepresentativeProfile : Profile
    {
        public AlternativeBusinessRepresentativeProfile()
        {
            ...
            CreateMap<AlternativeBusinessRepresentative, AlternativeBusinessRepresentativeViewModel>()
                .ForMember(x => x.IsValid, opt => opt.Ignore())
                .ForMember(x => x.BirthDetails, opt => opt.ResolveUsing(ProfileHelpers.BirthDetailsResolver<AlternativeBusinessRepresentativeViewModel>))
                ...
                .ForMember(x => x.RightToWork, opt => opt.ResolveUsing(ProfileHelpers.RightToWorkResolver))
            ...
            CreateMap<AlternativeBusinessRepresentativeViewModel, AlternativeBusinessRepresentative>()
                ...
                .ForMember(x => x.RequiresVisa, opt => opt.MapFrom(y => y.RightToWork.RequiresVisa))
                .ForMember(x => x.VisaDescription, opt => opt.MapFrom(y => y.RightToWork.VisaDescription))
